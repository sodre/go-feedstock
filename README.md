...
Once the `conda-forge` channel has been enabled, `go, go-cgo_linux-64, go-core, go_linux-64, go_osx-64, go_win-64` can be installed with:

```
conda install go go-cgo_linux-64 go-core go_linux-64 go_osx-64 go_win-64
```
